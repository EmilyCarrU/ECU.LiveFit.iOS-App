...
#import "ArmReachVideoViewController.h"


@implementation ArmReachVideoViewController
...
- (void)viewDidLoad
{
    ...
    //Set Url
    NSURL *movieURL = [[NSBundle mainBundle] URLForResource:@"ArmReach" withExtension:@"m4v"];
