//
//  GrapevineVideoViewController.m
//  longevity
//
...
#import "GrapevineVideoViewController.h"


@implementation GrapevineVideoViewController
...
- (void)viewDidLoad
{
    ...
    //Set Url
    NSURL *movieURL = [[NSBundle mainBundle] URLForResource:@"Grapevine2" withExtension:@"m4v"];
